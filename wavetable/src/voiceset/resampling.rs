...
// below is a polyphase iir halfband filter consisting of cascades of allpasses
// 
#[derive(Copy, Clone)]
struct Allpass {
    a : f32,
...
struct AllpassCascade {
    allpasses : [Allpass; 6], // FIXME: should probably be references to allpasses but lifetimes 
    num_filters : usize,
}
...
impl HalfbandFilter {
    fn setup(&mut self, order : usize, steep : bool) {
        ...
        if steep==true
        {
            ...
            {
                a_coefficients=
                vec![0.1271414136264853
                ,0.6528245886369117
                ,0.9176942834328115
                ];

                b_coefficients=
                vec![0.40056789819445626
                ,0.8204163891923343
                ,0.9763114515836773
                ];
            ...
            {
                a_coefficients=
                vec![0.12073211751675449
                ,0.6632020224193995
                ];

                b_coefficients=
                vec![0.3903621872345006
                ,0.890786832653497
                ];
            }
        ...
        else	//softer slopes, more attenuation and less stopband ripple
        {
            ...
            {
                a_coefficients=
                vec![0.06029739095712437
                ,0.4125907203610563
                ,0.7727156537429234
                ];

                b_coefficients=
                vec![0.21597144456092948
                ,0.6043586264658363
                ,0.9238861386532906
                ];
            }
            ...
            {
                a_coefficients=
                vec![0.07986642623635751
                ,0.5453536510711322
                ];

                b_coefficients=
                vec![0.28382934487410993
                ,0.8344118914807379
                ];
            }
